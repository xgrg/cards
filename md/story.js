...
function a1(){ return (vartable["@action"]=="Scene1"); };return (a1());
  ...
  storylet:function(choice){
  playSequence([    [function(){addDialog("<p>Ils peuvent arriver et me trouver ici d'une minute à l'autre.</p>", "fadeIn")}, 1000],
...
choices:[["Explorer d'autres pièces", {"exam_autrespieces": "true", "@action": "ExplorerAutresPi\u00e8ces"}],["S'approcher du coin cuisine", {"@action": "ApprocherCuisine", "exam_cuisine": "true"}],["S'approcher du coin bureau", {"@action": "ApprocherBureau", "exam_bureau": "true"}],["S'approcher du coin salon", {"exam_salon": "true", "@action": "ApprocherSalon"}],["Inspecter les assiettes", {}, function(){
function a1(){ return (vartable["exam_salon"]=="true"); };return (a1());
}],["Aller dans la salle de bains", {}, function(){
function a1(){ return (vartable["exam_autrespieces"]=="true"); };return (a1());
}],["Aller dans la chambre", {}, function(){
function a1(){ return (vartable["exam_autrespieces"]=="true"); };return (a1());
}],]
}
